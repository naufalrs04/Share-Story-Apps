...
import * as StorrAPI from '../../data/api';
...
export default class NewPage {
            ...
            <div class="form-control">
              ...
              <div class="new-form__description__container">
                <textarea
                  ...
                  name="description"
                  placeholder="Deskripsikan Story Anda"
                ></textarea>
              </div>
            </div>
            <div class="form-control">
  ...
  async #setupForm() {
    ...
    this.#form.addEventListener('submit', async (event) => {
      ...
      const title = this.#form.elements.namedItem('title').value;
      ...
      // Ambil gambar yang diupload atau dari kamera
      let photoFile = null;
      if (this.#takenDocumentations.length > 0) {
        photoFile = this.#takenDocumentations[0].blob; // Gunakan gambar pertama yang diambil
      }
      ...
      // Kirim data menggunakan presenter
      await this.#presenter.postNewReport(data);
    });

    // Event listener untuk file input dan kamera tetap seperti sebelumnya
